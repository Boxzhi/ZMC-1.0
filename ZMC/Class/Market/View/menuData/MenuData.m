...
-(void)getData
{
    ...
    for(int i=0 ; i<10 ; i++)
    {
        ...
        item.title=[NSString stringWithFormat:@"tid",i];
        [arr0 addObject:item];
        for(int j=0;j<3;j++)
        {
            MyItem *item=[[MyItem alloc] init];
            ...
            item.title=[NSString stringWithFormat:@"ti%d",10+i*3+j+1];
            [arr1 addObject:item];
            for(int m=0;m<2;m++)
            {
                MyItem *item=[[MyItem alloc] init];
                ...
                item.title=[NSString stringWithFormat:@"ti%d",40+i*3*2+j*2+m+1];
                [arr2 addObject:item];
            }
        }
    }
