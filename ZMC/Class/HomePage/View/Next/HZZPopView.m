...
#import "HZZPopView.h"
#import "HZZPopviewTableViewCell.h"
#define ScreenWidth [UIScreen mainScreen].bounds.size.width
#define ScreenHeight [UIScreen mainScreen].bounds.size.height
#define Length 5
#define Length2 15

static NSString *cellIdentifier = @"cellIdPop";

@interface HZZPopView ()<UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, assign) HZZDirectionType type;

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation HZZPopView

- (instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(CGFloat)height Type:(HZZDirectionType)type Color:(UIColor *)color
{
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.type) {
        case HZZypeOfUpLeft:
        case HZZypeOfUpCenter:
        case HZZypeOfUpRight:{
            {
        ...
        case HZZypeOfDownLeft:
        case HZZypeOfDownCenter:
        case HZZypeOfDownRight: {
            {
                CGFloat startX = self.origin.x;
                CGFloat startY = self.origin.y;
                CGContextMoveToPoint(context, startX, startY);
        ...
        case HZZypeOfLeftUp:
        case HZZypeOfLeftCenter:
        case HZZypeOfLeftDown: {
            {
                CGFloat startX = self.origin.x;
                CGFloat startY = self.origin.y;
                CGContextMoveToPoint(context, startX, startY);
        ...
        case HZZypeOfRightUp:
        case HZZypeOfRightCenter:
        case HZZypeOfRightDown: {
            {
                CGFloat startX = self.origin.x;
                CGFloat startY = self.origin.y;
                CGContextMoveToPoint(context, startX, startY);
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"HZZPopviewTableViewCell" bundle:nil] forCellReuseIdentifier:cellIdentifier];
...
//    }
    HZZPopviewTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    cell.cellLabel.text = self.dataArray[indexPath.row];
    cell.cellLabel.font = [UIFont systemFontOfSize:self.fontSize];
    cell.cellLabel.textColor = self.titleTextColor;
...
//    
//    if (indexPath.row == self.dataArray.count - 1) {
//        cell.separatorInset = UIEdgeInsetsMake(0, 0, 20, 0);
//    }
//}
