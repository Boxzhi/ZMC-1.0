...
@interface ZMCShippingViewController ()<UITableViewDelegate,UITableViewDataSource,WeChatStylePlaceHolderDelegate,UIAlertViewDelegate> {
...
@implementation ZMCShippingViewController
...
- (void)getOrderListInfo {
    ...
    [CommonHttpAPI getOrderListWithParameters:[CommonRequestModel getOrderListWithOrder_status:@"2" pageNO:ChangeNSIntegerToStr(self.currentPage) page_size:@"30"] success:^(NSURLSessionDataTask *task, id responseObject) {
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    if (orderList_model.result.data[section].order_status == 0) {
        button.hidden = YES;
        button1.hidden = YES;
    }
