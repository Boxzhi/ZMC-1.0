...
#import "XTPopView.h"
#import "ZMCPopviewTableViewCell.h"
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"ZMCPopviewTableViewCell" bundle:nil] forCellReuseIdentifier:cellIdentifier];
...
//    }
    ZMCPopviewTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    cell.cellimageView.image = [UIImage imageNamed:self.images[indexPath.row]];
