//
//  ZMCBottomSecondViewController.m
//  ZMC
//
...
@interface ZMCBottomSecondViewController ()<UITableViewDelegate, UITableViewDataSource, WeChatStylePlaceHolderDelegate>
...
@implementation ZMCBottomSecondViewController
...
- (void)sendRequest
{
    ...
    [CookBookNetwork requestDishListWithCategory:cates[1] andPage:[NSNumber numberWithInteger:_currentPage] andPageSize:@15 andComplete:^(NSMutableDictionary *Dic) {
        if (_currentPage == 1) {
