//
//  ZMCBottomFourthViewController.m
//  ZMC
//
...
@interface ZMCBottomFourthViewController ()<UITableViewDelegate, UITableViewDataSource, WeChatStylePlaceHolderDelegate>
...
@implementation ZMCBottomFourthViewController
...
- (void)sendRequest
{
    ...
    [CookBookNetwork requestDishListWithCategory:cates[3] andPage:[NSNumber numberWithInteger:_currentPage] andPageSize:@15 andComplete:^(NSMutableDictionary *Dic) {
        if (_currentPage == 1) {
