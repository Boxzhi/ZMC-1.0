//
//  ZMCBottomEighthViewController.m
//  ZMC
//
...
@interface ZMCBottomEighthViewController ()<UITableViewDelegate, UITableViewDataSource, WeChatStylePlaceHolderDelegate>
...
@implementation ZMCBottomEighthViewController
...
- (void)sendRequest
{
    ...
    [CookBookNetwork requestDishListWithCategory:cates[7] andPage:[NSNumber numberWithInteger:_currentPage] andPageSize:@15 andComplete:^(NSMutableDictionary *Dic) {
        if (_currentPage == 1) {
