//
//  ZMCBottomFifthViewController.m
//  ZMC
//
...
@interface ZMCBottomFifthViewController ()<UITableViewDelegate, UITableViewDataSource, WeChatStylePlaceHolderDelegate>
...
@implementation ZMCBottomFifthViewController
...
- (void)sendRequest
{
    ...
    [CookBookNetwork requestDishListWithCategory:cates[4] andPage:[NSNumber numberWithInteger:_currentPage] andPageSize:@15 andComplete:^(NSMutableDictionary *Dic) {
        if (_currentPage == 1) {
