//
//  ZMCBottomViewController.m
//  ZMC
//
//  Created by MindminiMac on 16/5/7.
...
@interface ZMCBottomViewController ()<UITableViewDelegate, UITableViewDataSource, WeChatStylePlaceHolderDelegate>
...
@implementation ZMCBottomViewController
...
- (void)sendRequest
{
    ...
    [CookBookNetwork requestDishListWithCategory:cates[0] andPage:[NSNumber numberWithInteger:_currentPage] andPageSize:@15 andComplete:^(NSMutableDictionary *Dic) {
        if (_currentPage == 1) {
