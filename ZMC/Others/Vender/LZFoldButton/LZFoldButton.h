...
typedef void(^AAFlodButtonBlock)(BOOL isOpen);
...
/** 设置按钮的代理 */
@property (assign,nonatomic) id <LZFoldButtonDelegate> lzDelegate;
/** 以block形式回调选中结果 */
@property (copy,nonatomic) LZFoldButtonBlock lzResultBlock;

@property (nonatomic, copy) AAFlodButtonBlock aaStatusBlock;
