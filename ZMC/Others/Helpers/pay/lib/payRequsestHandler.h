...
#define APP_ID          @"wx0280bbe0e71fd0e8"               //APPID
#define APP_SECRET      @"a7931e75fcc49ec3f871b18aff38f078" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1277352401"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"rFKbJRbgIhguwXI8QdXF2lCuO66zWp2r"
//支付结果回调页面
